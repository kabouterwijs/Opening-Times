class SlugTrapController < ApplicationController
  ...
  def show
    ...
    render 'facilities/retired' and return if @facility.retired?
    ...
    respond_to do |format|
      ...
      format.json  { render :json => @facility.to_json(:include => { :normal_openings => { :only => [], :methods => [:opens_at, :closes_at, :week_day] } }   ) }
    end
  end
